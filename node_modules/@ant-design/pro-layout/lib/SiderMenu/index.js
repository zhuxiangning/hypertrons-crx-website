...
var SiderMenuWrapper = function SiderMenuWrapper(props) {
  ...
  (0, _utils.useDeepCompareEffect)(function () {
    ...
    var newFlatMenus = (0, _SiderMenuUtils.getFlatMenus)(menuData);
  ...
  return isMobile ? _react.default.createElement(_drawer.default, {
    visible: !collapsed,
    placement: "left",
    className: (0, _classnames.default)('ant-pro-drawer-sider-menu', className),
    ...
    className: (0, _classnames.default)('ant-pro-sider-menu', className),
